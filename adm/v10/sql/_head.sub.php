...
<div id="sql_head">
    ...
    <a class="<?=(($g5['file_name'] == 'category_setting')?'focus':'')?>" href="<?=G5_USER_ADMIN_SQL_URL?>/category_setting.php">카테고리</a>
    <a class="<?=(($g5['file_name'] == 'category_setting2')?'focus':'')?>" href="<?=G5_USER_ADMIN_SQL_URL?>/category_setting2.php">카테고리&BOM정렬순서</a>
